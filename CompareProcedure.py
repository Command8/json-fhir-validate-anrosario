...
fileinput = (dir_path + '/' +'Procedure_SampleData_Input.json')
...
ProcedureDataInput = getResourceFile(fileinput)


#Traversing through json to identify the key values for validation    

print(ProcedureDataInput['NDC_CODE'])
print(ProcedureDataInput['NDC_DESCRIPTION'])

print(ProcedureDataInput['DATE_OF_SERVICE']) 
print(ProcedureDataInput['QUANTITY'])

print(ProcedureDataInput['CENSEOID'])
...
procedurefileoutput = ('MedicationRequest_converter.json')
#Another way to access parent directory to reference files into function
